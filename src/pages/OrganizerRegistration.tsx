...
import { User, Mail, Phone, Shield, MapPin, Boxes } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-lg mx-auto">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold text-gray-900">Cadastro de Organizador</h2>
          <p className="mt-2 text-sm text-gray-600">
            Crie e gerencie suas próprias comunidades de dominó
          </p>
        </div>
