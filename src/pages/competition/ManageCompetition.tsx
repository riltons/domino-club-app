...
export function ManageCompetition() {
  const { id } = useParams();
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="mt-1 text-gray-500">{competition.description}</p>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold">{competition.stats.totalMatches}</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold">{competition.stats.totalPlayers}</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold">{competition.stats.avgMatchesPerWeek}</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold">{competition.stats.topPlayer}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="border-b pb-4">
              ...
              <div className="flex items-center">
                <img
                  src={`https://ui-avatars.com/api/?name=${encodeURIComponent(competition.admin.name)}`}
                  alt={competition.admin.name}
                  className="h-8 w-8 rounded-full"
                />
                <span className="ml-2 text-sm text-gray-900">{competition.admin.name}</span>
              </div>
            </div>
            ...
            <div className="border-b pb-4">
              ...
              <div className="space-y-2">
                {competition.organizers.map(organizer => (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              {competition.competitions.map(comp => (
                <div key={comp.id} className="flex items-center justify-between">
                  ...
                  <span className="px-2 py-1 text-xs font-medium rounded-full bg-green-100 text-green-800">
                    {comp.status === 'in_progress' ? 'Em andamento' : 'Concluído'}
                  </span>
                </div>
              ))}
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              {competition.recentMatches.map(match => (
